...
'''
python test_gset.py --model_folder="/home/bcjexu/maxcut-80/bespoke-gnn4do/training_runs/230928_runs/230925_generated_preset_VC/paramhash:cc6823e1ed3cfabe4e6da1f22a84cb608a6664dff4d82038671b2487b9e9a6d6" \
    --model_file=model_step20000.pt --test_prefix=gset_timing
...
if __name__ == '__main__':
    ...
    gset_set = load_gset('datasets/GSET')
    ...
    predictions = time_and_scores(args, model, gset_set, stop_early=True)
    predictions = time_and_scores(args, model, gset_set)
    print(predictions)
